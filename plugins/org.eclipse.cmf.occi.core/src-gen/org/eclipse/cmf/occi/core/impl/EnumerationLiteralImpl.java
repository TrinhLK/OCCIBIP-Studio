...
public class EnumerationLiteralImpl extends MinimalEObjectImpl.Container implements EnumerationLiteral {
	...
	public boolean EnumerationLiteralNameRegex(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "EnumerationLiteral::EnumerationLiteralNameRegex";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.ENUMERATION_LITERAL___ENUMERATION_LITERAL_NAME_REGEX__DIAGNOSTICCHAIN_MAP);
