...
public class ExtensionImpl extends MinimalEObjectImpl.Container implements Extension {
	...
	public boolean KindsSchemeValid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Extension::KindsSchemeValid";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.EXTENSION___KINDS_SCHEME_VALID__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				Iterator<Object> ITERATOR_k = BOXED_kinds.iterator();
	...
	public boolean KindParentLocalOrImported(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Extension::KindParentLocalOrImported";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.EXTENSION___KIND_PARENT_LOCAL_OR_IMPORTED__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			...
			if (le) {
				...
				try {
					...
					final /*@NonInvalid*/ OrderedSetValue BOXED_kinds = idResolver.createOrderedSetOfAll(OCCITables.ORD_CLSSid_Kind, kinds);
					/*@Thrown*/ Object accumulator = ValueUtil.TRUE_VALUE;
					Iterator<Object> ITERATOR__1 = BOXED_kinds.iterator();
					...
					while (true) {
						...
						try {
							...
							if (!ne) {
								...
								try {
									/*@Caught*/ Object CAUGHT_parentExtension;
									try {
										if (parent == null) {
									...
									if (CAUGHT_eq == ValueUtil.TRUE_VALUE) {
										...
										try {
											final /*@NonInvalid*/ List<Extension> local_0 = this.getImport();
											final /*@NonInvalid*/ OrderedSetValue BOXED_local_0 = idResolver.createOrderedSetOfAll(OCCITables.ORD_CLSSid_Extension, local_0);
											if (CAUGHT_parentExtension instanceof InvalidValueException) {
												throw (InvalidValueException)CAUGHT_parentExtension;
											}
											final /*@Thrown*/ boolean includes = CollectionIncludesOperation.INSTANCE.evaluate(BOXED_local_0, CAUGHT_parentExtension).booleanValue();
	...
	public boolean MixinsSchemeValid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Extension::MixinsSchemeValid";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.EXTENSION___MIXINS_SCHEME_VALID__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_0;
			if (le) {
				local_0 = true;
				...
				try {
					...
					/*@Thrown*/ Object accumulator = ValueUtil.TRUE_VALUE;
					Iterator<Object> ITERATOR_m = BOXED_mixins.iterator();
					/*@Thrown*/ Boolean result;
					while (true) {
	...
	public boolean TermUnicity(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Extension::TermUnicity";
		try {
			/**
			 *
			 * inv TermUnicity:
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.EXTENSION___TERM_UNICITY__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_0;
			if (le) {
				local_0 = true;
				...
				final /*@NonInvalid*/ List<Kind> kinds = this.getKinds();
				final /*@NonInvalid*/ OrderedSetValue BOXED_kinds = idResolver.createOrderedSetOfAll(OCCITables.ORD_CLSSid_Kind, kinds);
				/*@Thrown*/ Accumulator accumulator = ValueUtil.createSequenceAccumulatorValue(OCCITables.SEQ_PRIMid_String);
				Iterator<Object> ITERATOR__1 = BOXED_kinds.iterator();
				...
				final /*@NonInvalid*/ List<Mixin> mixins = this.getMixins();
				final /*@NonInvalid*/ OrderedSetValue BOXED_mixins = idResolver.createOrderedSetOfAll(OCCITables.ORD_CLSSid_Mixin, mixins);
				/*@Thrown*/ Accumulator accumulator_0 = ValueUtil.createSequenceAccumulatorValue(OCCITables.SEQ_PRIMid_String);
				Iterator<Object> ITERATOR__1_0 = BOXED_mixins.iterator();
	...
	public boolean MixinAppliesLocalOrImported(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Extension::MixinAppliesLocalOrImported";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.EXTENSION___MIXIN_APPLIES_LOCAL_OR_IMPORTED__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_1;
			if (le) {
				local_1 = true;
						...
						try {
							...
							if (eq) {
								...
								try {
									final /*@NonInvalid*/ List<Extension> local_0 = this.getImport();
									final /*@NonInvalid*/ OrderedSetValue BOXED_local_0 = idResolver.createOrderedSetOfAll(OCCITables.ORD_CLSSid_Extension, local_0);
									final /*@Thrown*/ boolean includes = CollectionIncludesOperation.INSTANCE.evaluate(BOXED_local_0, extension).booleanValue();
									CAUGHT_includes = includes;
								}
								catch (Exception e) {
									CAUGHT_includes = ValueUtil.createInvalidValue(e);
	...
	public boolean SchemeUnique(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Extension::SchemeUnique";
		try {
			/**
			 *
			 * inv SchemeUnique:
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.EXTENSION___SCHEME_UNIQUE__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_0;
			if (le) {
				local_0 = true;
				...
				/*@Thrown*/ org.eclipse.ocl.pivot.values.SetValue.Accumulator accumulator = ValueUtil.createSetAccumulatorValue(OCCITables.SET_CLSSid_Extension);
	...
	public boolean MixinDependsLocalOrImported(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Extension::MixinDependsLocalOrImported";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.EXTENSION___MIXIN_DEPENDS_LOCAL_OR_IMPORTED__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_1;
			if (le) {
				local_1 = true;
