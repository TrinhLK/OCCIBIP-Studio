...
public class KindImpl extends TypeImpl implements Kind {
  ...
  @Override
	...
	public boolean NoCyclicInheritance(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Kind::NoCyclicInheritance";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.KIND___NO_CYCLIC_INHERITANCE__DIAGNOSTICCHAIN_MAP);
				...
				try {
					...
					final AbstractBinaryOperation BODY_closure_0 = new AbstractBinaryOperation() {
						...
						public /*@Nullable*/ Object evaluate(final Executor executor, final TypeId typeId, final /*@Nullable*/ Object oclAsSet, final /*@NonInvalid*/ Object _1) {
							...
							final /*@Thrown*/ Kind parent_0 = local_0.getParent();
							return parent_0;
						}
					};
	...
	public boolean AttributesNameNotAlreadyDefinedInParent(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Kind::AttributesNameNotAlreadyDefinedInParent";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ StandardLibrary standardLibrary = idResolver.getStandardLibrary();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.KIND___ATTRIBUTES_NAME_NOT_ALREADY_DEFINED_IN_PARENT__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_1;
			if (le) {
				local_1 = true;
				...
				try {
					...
					final ExecutorSingleIterationManager MGR_closure_0 = new ExecutorSingleIterationManager(executor, OCCITables.SET_CLSSid_Kind, BODY_closure_0, oclAsSet, ACC_closure_0);
					final /*@Thrown*/ SetValue closure = (SetValue)IMPL_closure_0.evaluateIteration(MGR_closure_0);
					/*@Thrown*/ org.eclipse.ocl.pivot.values.BagValue.Accumulator accumulator_0 = ValueUtil.createBagAccumulatorValue(OCCITables.BAG_CLSSid_Attribute);
					...
					/*@Thrown*/ org.eclipse.ocl.pivot.values.BagValue.Accumulator accumulator_1 = ValueUtil.createBagAccumulatorValue(OCCITables.BAG_DATAid_AttributeName);
	...
	public boolean sourceReferenceInvariant(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Kind::sourceReferenceInvariant";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ StandardLibrary standardLibrary = idResolver.getStandardLibrary();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.KIND___SOURCE_REFERENCE_INVARIANT__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			...
			if (le) {
				...
				try {
					...
					if (gt) {
						...
						try {
							...
							final org.eclipse.ocl.pivot.Class TYPE_closure_1 = executor.getStaticTypeOfValue(null, oclAsSet);
							final LibraryIterationExtension IMPL_closure_1 = (LibraryIterationExtension)TYPE_closure_1.lookupImplementation(standardLibrary, OCLstdlibTables.Operations._Set__closure);
							 ...
							 * Implementation of the iterator body.
							 */
							final AbstractBinaryOperation BODY_closure_1 = new AbstractBinaryOperation() {
								/**
								 * parent
								 */
								@Override
							...
							final ExecutorSingleIterationManager MGR_closure_1 = new ExecutorSingleIterationManager(executor, OCCITables.SET_CLSSid_Kind, BODY_closure_1, oclAsSet, ACC_closure_1);
							final /*@Thrown*/ SetValue closure = (SetValue)IMPL_closure_1.evaluateIteration(MGR_closure_1);
						...
						if (CAUGHT_exists == ValueUtil.FALSE_VALUE) {
							...
							try {
								...
								Iterator<Object> ITERATOR_sourceKind = BOXED_source.iterator();
								...
								while (true) {
									...
									try {
										...
										final org.eclipse.ocl.pivot.Class TYPE_closure_0_0 = executor.getStaticTypeOfValue(null, oclAsSet_0);
										...
										final AbstractBinaryOperation BODY_closure_0_0 = new AbstractBinaryOperation() {
											 ...
											 */
											@Override
											public /*@Nullable*/ Object evaluate(final Executor executor, final TypeId typeId, final /*@Nullable*/ Object oclAsSet_0, final /*@NonInvalid*/ Object _1_0) {
												final /*@NonInvalid*/ Kind local_1 = (Kind)_1_0;
												if (local_1 == null) {
													throw new InvalidValueException("Null source for \'\'http://schemas.ogf.org/occi/core/ecore\'::Kind::parent\'");
												}
												final /*@Thrown*/ Kind parent_0 = local_1.getParent();
												return parent_0;
											}
										};
										final ExecutorSingleIterationManager MGR_closure_0_0 = new ExecutorSingleIterationManager(executor, OCCITables.SET_CLSSid_Kind, BODY_closure_0_0, oclAsSet_0, ACC_closure_0_0);
										...
										Iterator<Object> ITERATOR_k_0 = closure_0.iterator();
					...
					if (eq_3) {
						...
						final /*@Thrown*/ TupleValue local_2 = ValueUtil.createTupleOfEach(OCCITables.TUPLid__0, sum_0, OCCITables.STR_quickfix, diff, status);
						local_3 = local_2;
					}
				...
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_local_3, OCCITables.INT_0).booleanValue();
	...
	public boolean CorrectScheme(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Kind::CorrectScheme";
		try {
			/**
			 *
			 * inv CorrectScheme:
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.KIND___CORRECT_SCHEME__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			...
			if (le) {
				...
				try {
					...
					final /*@Thrown*/ Extension oclAsType = (Extension)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, oclContainer, TYP_occi_c_c_Extension);
	...
	public boolean targetReferenceInvariant(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Kind::targetReferenceInvariant";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ StandardLibrary standardLibrary = idResolver.getStandardLibrary();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.KIND___TARGET_REFERENCE_INVARIANT__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_4;
			if (le) {
				local_4 = true;
				...
				try {
					...
					if (gt) {
						...
						if (CAUGHT_exists == ValueUtil.FALSE_VALUE) {
							...
							try {
								/*@Thrown*/ Object accumulator_0 = ValueUtil.TRUE_VALUE;
								Iterator<Object> ITERATOR_targetKind = BOXED_target.iterator();
								/*@Thrown*/ Boolean forAll;
								while (true) {
	...
	public boolean EntityKindIsRootParent(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Kind::EntityKindIsRootParent";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ StandardLibrary standardLibrary = idResolver.getStandardLibrary();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.KIND___ENTITY_KIND_IS_ROOT_PARENT__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, OCCITables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_1;
			if (le) {
				local_1 = true;
