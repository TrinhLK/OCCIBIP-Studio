...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public boolean containedActionMustBeDeclaredInTheAppropriateType(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Transition::containedActionMustBeDeclaredInTheAppropriateType";
		try {
			/**
			 *
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, OCCIPackage.Literals.TRANSITION___CONTAINED_ACTION_MUST_BE_DECLARED_IN_THE_APPROPRIATE_TYPE__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					...
					final /*@Thrown*/ State oclAsType = (State)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, oclContainer, TYP_occi_c_c_State);
					final /*@Thrown*/ Object oclContainer_0 = ClassifierOclContainerOperation.INSTANCE.evaluate(executor, oclAsType);
					final /*@Thrown*/ FSM oclAsType_0 = (FSM)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, oclContainer_0, TYP_occi_c_c_FSM);
					final /*@Thrown*/ Object oclContainer_1 = ClassifierOclContainerOperation.INSTANCE.evaluate(executor, oclAsType_0);
					final /*@Thrown*/ Type type = (Type)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, oclContainer_1, TYP_occi_c_c_Type_0);
					...
					if (ne) {
						...
						final /*@Thrown*/ Kind oclAsType_1 = (Kind)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, TYP_occi_c_c_Kind);
						...
						/*@Thrown*/ Accumulator accumulator = ValueUtil.createBagAccumulatorValue(OCCITables.BAG_CLSSid_Action);
						Iterator<Object> ITERATOR_k = flatten.iterator();
						...
						if (flatten_0 instanceof InvalidValueException) {
							throw (InvalidValueException)flatten_0;
						}
					...
					if (local_1) {
						...
						if (ne_0) {
							...
							final /*@Thrown*/ Type oclAsType_2 = (Type)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, oclContainer_2, TYP_occi_c_c_Type_0);
							...
							final /*@Thrown*/ Type oclAsType_5 = (Type)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, oclContainer_1, TYP_occi_c_c_Type_0);
							...
							final /*@Thrown*/ Type oclAsType_6 = (Type)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, oclContainer_6, TYP_occi_c_c_Type_0);
						...
						final /*@Thrown*/ TupleValue local_3 = ValueUtil.createTupleOfEach(OCCITables.TUPLid_, local_2, diff, local_1);
						local_4 = local_3;
					}
				...
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_local_4, OCCITables.INT_0).booleanValue();
